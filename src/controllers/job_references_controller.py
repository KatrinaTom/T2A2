...
# create controller
job_references = Blueprint('job_references', __name__, url_prefix='/job_references')
...
def get_job_references():
    ...
    # result = job_references_schema.dump(job_references_list)
...
def create_job_reference():
    ...
    # job_reference_fields = job_references_schema.load(request.json)
    ...
    # return jsonify(job_references_schema.dump(new_job_reference))
